...
document.addEventListener('mouseup', function(event) {
  if (selectedSlider == null) {
    ...
    if(namingProjectileName && tempProjectileName != '' && !contains(Object.keys(newFighterData['projectiles']), tempProjectileName) && !contains(Object.keys(newFighterData['effects']), tempProjectileName)) {
  ...
  switch (event.keyCode) {
    ...
    case 13: // Enter
      if(naming && tempName != '') {
        ...
        tempProjectile = '';
        newFighterData['effects'][newFighterAction][newFighterFrame]['projectile'] = newFighterProjectile[newFighterAction][newFighterFrame];
      } else if(namingProjectileName && tempProjectileName != '' && !contains(Object.keys(newFighterData['projectiles']), tempProjectileName) && !contains(Object.keys(newFighterData['effects']), tempProjectileName)) {
        for(var i in newFighterData) {
          if(typeof newFighterData[i] === 'object' && contains(Object.keys(newFighterData[i]), newFighterAction)) {
            newFighterData[i][tempProjectileName] = newFighterData[i][newFighterAction];
            delete newFighterData[i][newFighterAction];
